...
#    b. we don't have a stock in hand at day i-1, then we buy a stock at day i, so the cash we have is dp[i-1][1] - prices[i]
...
#    b. we have a stock in hand at day i-1, then we sell the stock at day i, so the cash we have is dp[i-1][0] + prices[i]
